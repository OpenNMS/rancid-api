...
namespace eval ::HTTP {
  ...
  #--------------------------------------------------------------------------
  # Questa funzione viene chiamata quando il modulo � eseguito come CGI
  # server-script: crea un namespace relativo alla request e ne restituisce
  # il nome. Dal momento che in modalit� CGI ogni request comporta una
  # diversa istanza dello script, il namespace � creato con un nome fisso
  # pari a ::REQ_CGI
...
namespace eval ::RWS {
  ...
  proc RegisterService { service_label service_table_entry } {
    ...
    # prevedere test sulla validit� dei parametri ?
